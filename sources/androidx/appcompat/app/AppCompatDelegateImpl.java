...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    @Override // androidx.appcompat.app.AppCompatDelegate
    public void onConfigurationChanged(Configuration newConfig) throws PackageManager.NameNotFoundException {
        ActionBar ab;
    ...
    */
    ...
    private boolean applyApplicationSpecificConfig(boolean allowRecreation, boolean isLocalesApplicationRequired) throws PackageManager.NameNotFoundException {
        if (this.mDestroyed) {
            return false;
        }
    ...
    private boolean updateAppConfiguration(int nightMode, LocaleListCompat locales, boolean allowRecreation) throws PackageManager.NameNotFoundException {
