...
public class ConstraintWidget {
    ...
    /* JADX WARN: Removed duplicated region for block: B:326:0x069d  */
    ...
    */
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        if (this.mParent == null) {
            ...
            boolean z18 = this.mParent != null && this.mParent.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT;
            boolean z19 = this.mParent != null && this.mParent.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT;
        ...
        boolean z20 = this.mListDimensionBehaviors[0] != DimensionBehaviour.MATCH_CONSTRAINT;
        boolean z21 = this.mListDimensionBehaviors[1] != DimensionBehaviour.MATCH_CONSTRAINT;
        boolean z22 = false;
        ...
        if (this.mDimensionRatio <= 0.0f || this.mVisibility == 8) {
            ...
            if (this.mListDimensionBehaviors[0] != DimensionBehaviour.MATCH_CONSTRAINT || this.mListDimensionBehaviors[1] != DimensionBehaviour.MATCH_CONSTRAINT || i12 != 3 || i13 != 3) {
                z7 = z4;
                if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT && i12 == 3) {
                    this.mResolvedDimensionRatioSide = 0;
                    int i15 = (int) (this.mResolvedDimensionRatio * this.mHeight);
                    if (this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT) {
                        i3 = i12;
                        i2 = i13;
                        i5 = i15;
                ...
                this.mResolvedMatchConstraintDefault[1] = i2;
                this.mResolvedHasRatio = z8;
                boolean z23 = !z8 && (this.mResolvedDimensionRatioSide == 0 || this.mResolvedDimensionRatioSide == -1);
                boolean z24 = !z8 && (this.mResolvedDimensionRatioSide == 1 || this.mResolvedDimensionRatioSide == -1);
                ...
                boolean z25 = this.mIsInBarrier[0];
                boolean z26 = this.mIsInBarrier[1];
                if (this.mHorizontalResolution != 2 || this.resolvedHorizontal) {
                    ...
                    solverVariable4 = solverVariableCreateObjectVariable2;
                    solverVariable5 = solverVariableCreateObjectVariable;
                    applyConstraints(linearSystem, true, z2, z12, this.isTerminalWidget[0], this.mParent != null ? linearSystem.createObjectVariable(this.mParent.mLeft) : null, solverVariableCreateObjectVariable6, this.mListDimensionBehaviors[0], z9, this.mLeft, this.mRight, this.mX, i6, this.mMinWidth, this.mMaxDimension[0], this.mHorizontalBiasPercent, z23, this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT, z5, z6, z25, i3, i2, this.mMatchConstraintMinWidth, this.mMatchConstraintMaxWidth, this.mMatchConstraintPercentWidth, z10);
                } else if (z) {
                    linearSystem.addEquality(solverVariableCreateObjectVariable, this.horizontalRun.start.value);
                    linearSystem.addEquality(solverVariableCreateObjectVariable2, this.horizontalRun.end.value);
                ...
                if (z) {
                    ...
                    constraintWidget = this;
                    if (constraintWidget.verticalRun != null && constraintWidget.verticalRun.start.resolved && constraintWidget.verticalRun.end.resolved) {
                        linearSystem2 = linearSystem;
                        solverVariable8 = solverVariable3;
                        linearSystem2.addEquality(solverVariable8, constraintWidget.verticalRun.start.value);
                        ...
                        linearSystem2.addEquality(solverVariable6, constraintWidget.verticalRun.baseline.value);
                        if (constraintWidget.mParent == null) {
                            ...
                            if (z6 || !z12) {
                                ...
                                if (constraintWidget.isTerminalWidget[1]) {
                                    i7 = 8;
                                    i8 = 0;
                                    linearSystem2.addGreaterThan(linearSystem2.createObjectVariable(constraintWidget.mParent.mBottom), solverVariable7, 0, 8);
                                }
                            }
                            i7 = 8;
                            i8 = 0;
                    ...
                    if (z14 && !constraintWidget.resolvedVertical) {
                        boolean z28 = (constraintWidget.mListDimensionBehaviors[r2] == DimensionBehaviour.WRAP_CONTENT && (constraintWidget instanceof ConstraintWidgetContainer)) ? r2 : i8;
                        if (!z28) {
                            i9 = i4;
                        } else {
                            i9 = 0;
                        }
                        SolverVariable solverVariableCreateObjectVariable7 = constraintWidget.mParent != null ? linearSystem2.createObjectVariable(constraintWidget.mParent.mBottom) : null;
                        SolverVariable solverVariableCreateObjectVariable8 = constraintWidget.mParent != null ? linearSystem2.createObjectVariable(constraintWidget.mParent.mTop) : null;
                        if (constraintWidget.mBaselineDistance > 0 || constraintWidget.mVisibility == i7) {
                            if (constraintWidget.mBaseline.mTarget != null) {
                                ...
                                linearSystem2.addEquality(solverVariable6, linearSystem2.createObjectVariable(constraintWidget.mBaseline.mTarget), constraintWidget.mBaseline.getMargin(), i7);
                                if (z12) {
                                    linearSystem2.addGreaterThan(solverVariableCreateObjectVariable7, linearSystem2.createObjectVariable(constraintWidget.mBottom), i8, 5);
                                }
                                z15 = false;
                                applyConstraints(linearSystem, false, z12, z11, constraintWidget.isTerminalWidget[r2], solverVariableCreateObjectVariable8, solverVariableCreateObjectVariable7, constraintWidget.mListDimensionBehaviors[r2], z28, constraintWidget.mTop, constraintWidget.mBottom, constraintWidget.mY, i9, constraintWidget.mMinHeight, constraintWidget.mMaxDimension[r2], constraintWidget.mVerticalBiasPercent, z24, constraintWidget.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT, z6, z5, z26, i2, i3, constraintWidget.mMatchConstraintMinHeight, constraintWidget.mMatchConstraintMaxHeight, constraintWidget.mMatchConstraintPercentHeight, z15);
                            } else {
                                if (constraintWidget.mVisibility == i7) {
                                    linearSystem2.addEquality(solverVariable6, solverVariable8, constraintWidget.mBaseline.getMargin(), i7);
                                } else {
                                    linearSystem2.addEquality(solverVariable6, solverVariable8, getBaselineDistance(), i7);
                                }
                                z15 = z10;
                    ...
                    if (z13) {
                        if (constraintWidget.mResolvedDimensionRatioSide == 1) {
                            linearSystem.addRatio(solverVariable7, solverVariable8, solverVariable4, solverVariable5, constraintWidget.mResolvedDimensionRatio, 8);
                        } else {
                            linearSystem.addRatio(solverVariable4, solverVariable5, solverVariable7, solverVariable8, constraintWidget.mResolvedDimensionRatio, 8);
                        }
                    }
            ...
            z7 = z4;
            setupDimensionRatio(z2, z7, z20, z21);
        }
        i3 = i12;
        i2 = i13;
        i5 = i14;
        ...
        boolean z252 = this.mIsInBarrier[0];
        boolean z262 = this.mIsInBarrier[1];
