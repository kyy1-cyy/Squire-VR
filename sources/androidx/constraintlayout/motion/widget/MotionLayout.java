    ...
    */
    ...
    class Model {
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                String a = HttpUrl.FRAGMENT_ENCODE_SET + (child.mTop.mTarget != null ? ExifInterface.GPS_DIRECTION_TRUE : "_");
    ...
    private class DevModeDraw {
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x, float y) {
            ...
            String text = HttpUrl.FRAGMENT_ENCODE_SET + (((int) (((xgap * 100.0f) / Math.abs(x2 - x1)) + 0.5d)) / 100.0f);
            getTextBounds(text, this.mTextPaint);
            ...
            String text2 = HttpUrl.FRAGMENT_ENCODE_SET + (((int) (((ygap * 100.0f) / Math.abs(y2 - y1)) + 0.5d)) / 100.0f);
        ...
        private void drawPathScreenTicks(Canvas canvas, float x, float y, int viewWidth, int viewHeight) {
            String text = HttpUrl.FRAGMENT_ENCODE_SET + (((int) ((((x - (viewWidth / 2)) * 100.0f) / (MotionLayout.this.getWidth() - viewWidth)) + 0.5d)) / 100.0f);
            getTextBounds(text, this.mTextPaint);
            ...
            String text2 = HttpUrl.FRAGMENT_ENCODE_SET + (((int) ((((y - (viewHeight / 2)) * 100.0f) / (MotionLayout.this.getHeight() - viewHeight)) + 0.5d)) / 100.0f);
            getTextBounds(text2, this.mTextPaint);
