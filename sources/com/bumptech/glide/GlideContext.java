...
public class GlideContext extends ContextWrapper {
    ...
    public GlideContext(Context context, ArrayPool arrayPool, GlideSuppliers.GlideSupplier<Registry> registry, ImageViewTargetFactory imageViewTargetFactory, Glide.RequestOptionsFactory defaultRequestOptionsFactory, Map<Class<?>, TransitionOptions<?, ?>> defaultTransitionOptions, List<RequestListener<Object>> defaultRequestListeners, Engine engine, GlideExperiments experiments, int logLevel) {
