...
public interface ReceiveChannel<E> {
    ...
    Object mo1638receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1639tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1639tryReceivePtdJZtk = receiveChannel.mo1639tryReceivePtdJZtk();
            if (ChannelResult.m1655isSuccessimpl(objMo1639tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1651getOrThrowimpl(objMo1639tryReceivePtdJZtk);
            }
            Throwable thM1649exceptionOrNullimpl = ChannelResult.m1649exceptionOrNullimpl(objMo1639tryReceivePtdJZtk);
            if (thM1649exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1649exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            switch (anonymousClass12.label) {
                case 0:
                    ...
                    objMo1638receiveCatchingJP2dKIU = receiveChannel.mo1638receiveCatchingJP2dKIU(anonymousClass12);
                ...
                case 1:
                    ResultKt.throwOnFailure($result);
                    objMo1638receiveCatchingJP2dKIU = ((ChannelResult) $result).getHolder();
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            return ChannelResult.m1650getOrNullimpl(objMo1638receiveCatchingJP2dKIU);
        }
