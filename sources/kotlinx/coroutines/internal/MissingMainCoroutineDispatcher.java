...
final class MissingMainCoroutineDispatcher extends MainCoroutineDispatcher implements Delay {
    ...
    public /* bridge */ /* synthetic */ void mo1686scheduleResumeAfterDelay(long timeMillis, CancellableContinuation continuation) {
    ...
    public String toString() {
        return "Dispatchers.Main[missing" + (this.cause != null ? Intrinsics.stringPlus(", cause=", this.cause) : HttpUrl.FRAGMENT_ENCODE_SET) + ']';
    }
}
