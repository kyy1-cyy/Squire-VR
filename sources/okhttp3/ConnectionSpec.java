...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m1725deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m1727deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public int hashCode() {
        ...
        int i = 17 * 31;
        String[] strArr = this.cipherSuitesAsString;
        int iHashCode = (i + (strArr == null ? 0 : Arrays.hashCode(strArr))) * 31;
