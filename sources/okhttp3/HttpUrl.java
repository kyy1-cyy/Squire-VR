...
public final class HttpUrl {
    ...
    public final URL m1766deprecated_url() {
        return url();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to toUri()", replaceWith = @ReplaceWith(expression = "toUri()", imports = {}))
    /* renamed from: -deprecated_uri, reason: not valid java name */
    public final URI m1765deprecated_uri() {
        return uri();
    }
    ...
    public final String m1754deprecated_encodedUsername() {
    ...
    public final String m1750deprecated_encodedPassword() {
    ...
    public final int m1759deprecated_pathSize() {
        return pathSize();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedPath", imports = {}))
    /* renamed from: -deprecated_encodedPath, reason: not valid java name */
    public final String m1751deprecated_encodedPath() {
        return encodedPath();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedPathSegments", imports = {}))
    /* renamed from: -deprecated_encodedPathSegments, reason: not valid java name */
    public final List<String> m1752deprecated_encodedPathSegments() {
        return encodedPathSegments();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "pathSegments", imports = {}))
    /* renamed from: -deprecated_pathSegments, reason: not valid java name */
    public final List<String> m1758deprecated_pathSegments() {
        return this.pathSegments;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedQuery", imports = {}))
    /* renamed from: -deprecated_encodedQuery, reason: not valid java name */
    public final String m1753deprecated_encodedQuery() {
        return encodedQuery();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "query", imports = {}))
    /* renamed from: -deprecated_query, reason: not valid java name */
    public final String m1761deprecated_query() {
        return query();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "querySize", imports = {}))
    /* renamed from: -deprecated_querySize, reason: not valid java name */
    public final int m1763deprecated_querySize() {
        return querySize();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "queryParameterNames", imports = {}))
    /* renamed from: -deprecated_queryParameterNames, reason: not valid java name */
    public final Set<String> m1762deprecated_queryParameterNames() {
        return queryParameterNames();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedFragment", imports = {}))
    /* renamed from: -deprecated_encodedFragment, reason: not valid java name */
    public final String m1749deprecated_encodedFragment() {
    ...
    public static final class Builder {
        ...
        public final Builder fragment(String fragment) {
            ...
            $this$fragment_u24lambda_u2d26.setEncodedFragment$okhttp(fragment == null ? null : Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, fragment, 0, 0, HttpUrl.FRAGMENT_ENCODE_SET, false, false, false, true, null, 187, null));
            return this;
        }

        public final Builder encodedFragment(String encodedFragment) {
            Builder $this$encodedFragment_u24lambda_u2d27 = this;
            $this$encodedFragment_u24lambda_u2d27.setEncodedFragment$okhttp(encodedFragment == null ? null : Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedFragment, 0, 0, HttpUrl.FRAGMENT_ENCODE_SET, true, false, false, true, null, 179, null));
            return this;
        }
        ...
        public final Builder reencodeForUri$okhttp() {
            ...
            $this$reencodeForUri_u24lambda_u2d28.setHost$okhttp(host == null ? null : new Regex("[\"<>^`{|}]").replace(host, HttpUrl.FRAGMENT_ENCODE_SET));
        ...
        */
        public String toString() {
            StringBuilder $this$toString_u24lambda_u2d31 = new StringBuilder();
            if (getScheme() != null) {
                $this$toString_u24lambda_u2d31.append(getScheme());
                $this$toString_u24lambda_u2d31.append("://");
            } else {
                $this$toString_u24lambda_u2d31.append("//");
            }
            if (getEncodedUsername().length() > 0) {
                $this$toString_u24lambda_u2d31.append(getEncodedUsername());
                if (getEncodedPassword().length() > 0) {
                    $this$toString_u24lambda_u2d31.append(':');
                    $this$toString_u24lambda_u2d31.append(getEncodedPassword());
                }
                $this$toString_u24lambda_u2d31.append('@');
            } else {
                if (getEncodedPassword().length() > 0) {
            ...
            if (getHost() != null) {
                ...
                if (StringsKt.contains$default((CharSequence) host, ':', false, 2, (Object) null)) {
                    $this$toString_u24lambda_u2d31.append('[');
                    $this$toString_u24lambda_u2d31.append(getHost());
                    $this$toString_u24lambda_u2d31.append(']');
                } else {
                    $this$toString_u24lambda_u2d31.append(getHost());
                }
            ...
            if (getPort() != -1 || getScheme() != null) {
                ...
                if (getScheme() != null) {
                    ...
                    if (effectivePort != companion.defaultPort(scheme)) {
                        $this$toString_u24lambda_u2d31.append(':');
                        $this$toString_u24lambda_u2d31.append(effectivePort);
                    }
                }
            }
            HttpUrl.INSTANCE.toPathString$okhttp(getEncodedPathSegments$okhttp(), $this$toString_u24lambda_u2d31);
            if (getEncodedQueryNamesAndValues$okhttp() != null) {
                ...
                Intrinsics.checkNotNull(encodedQueryNamesAndValues$okhttp);
                companion2.toQueryString$okhttp(encodedQueryNamesAndValues$okhttp, $this$toString_u24lambda_u2d31);
            }
            if (getEncodedFragment() != null) {
                $this$toString_u24lambda_u2d31.append('#');
                $this$toString_u24lambda_u2d31.append(getEncodedFragment());
            }
            String string = $this$toString_u24lambda_u2d31.toString();
        ...
        /* compiled from: HttpUrl.kt */
        @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J \u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J \u0010\n\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J \u0010\u000b\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J\u001c\u0010\f\u001a\u00020\u0006*\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0080T¢\u0006\u0002\n\u0000¨\u0006\r"}, d2 = {"Lokhttp3/HttpUrl$Builder$Companion;", HttpUrl.FRAGMENT_ENCODE_SET, "()V", "INVALID_HOST", HttpUrl.FRAGMENT_ENCODE_SET, "parsePort", HttpUrl.FRAGMENT_ENCODE_SET, "input", "pos", "limit", "portColonOffset", "schemeDelimiterOffset", "slashCount", "okhttp"}, k = 1, mv = {1, 6, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    public static final class Companion {
        ...
        public final HttpUrl m1768deprecated_get(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        public final HttpUrl m1771deprecated_parse(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return parse(url);
        }
        ...
        @Deprecated(level = DeprecationLevel.ERROR, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "url.toHttpUrlOrNull()", imports = {"okhttp3.HttpUrl.Companion.toHttpUrlOrNull"}))
        /* renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m1770deprecated_get(URL url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        /* renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m1769deprecated_get(URI uri) {
