...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public final List<Interceptor> m1796deprecated_interceptors() {
        return this.interceptors;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "networkInterceptors", imports = {}))
    /* renamed from: -deprecated_networkInterceptors, reason: not valid java name */
    public final List<Interceptor> m1797deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }
    ...
    public final SSLSocketFactory m1806deprecated_sslSocketFactory() {
        return sslSocketFactory();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "connectionSpecs", imports = {}))
    /* renamed from: -deprecated_connectionSpecs, reason: not valid java name */
    public final List<ConnectionSpec> m1788deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "protocols", imports = {}))
    /* renamed from: -deprecated_protocols, reason: not valid java name */
    public final List<Protocol> m1799deprecated_protocols() {
        return this.protocols;
    }
    ...
    public static final class Builder {
        ...
        public final Builder dispatcher(Dispatcher dispatcher) {
            ...
            Builder $this$dispatcher_u24lambda_u2d0 = this;
        ...
        public final Builder connectionPool(ConnectionPool connectionPool) {
            ...
            Builder $this$connectionPool_u24lambda_u2d1 = this;
        ...
        public final Builder addInterceptor(Interceptor interceptor) {
            ...
            Builder $this$addInterceptor_u24lambda_u2d2 = this;
            $this$addInterceptor_u24lambda_u2d2.getInterceptors$okhttp().add(interceptor);
            return this;
        }

        /* renamed from: -addInterceptor, reason: not valid java name */
        public final Builder m1808addInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
        ...
        public final Builder addNetworkInterceptor(Interceptor interceptor) {
            Intrinsics.checkNotNullParameter(interceptor, "interceptor");
            Builder $this$addNetworkInterceptor_u24lambda_u2d3 = this;
            $this$addNetworkInterceptor_u24lambda_u2d3.getNetworkInterceptors$okhttp().add(interceptor);
            return this;
        }

        /* renamed from: -addNetworkInterceptor, reason: not valid java name */
        public final Builder m1809addNetworkInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
            Intrinsics.checkNotNullParameter(block, "block");
        ...
        public final Builder eventListener(EventListener eventListener) {
            ...
            Builder $this$eventListener_u24lambda_u2d4 = this;
        ...
        public final Builder eventListenerFactory(EventListener.Factory eventListenerFactory) {
            ...
            Builder $this$eventListenerFactory_u24lambda_u2d5 = this;
        ...
        public final Builder retryOnConnectionFailure(boolean retryOnConnectionFailure) {
            Builder $this$retryOnConnectionFailure_u24lambda_u2d6 = this;
        ...
        public final Builder authenticator(Authenticator authenticator) {
            ...
            Builder $this$authenticator_u24lambda_u2d7 = this;
        ...
        public final Builder followRedirects(boolean followRedirects) {
            Builder $this$followRedirects_u24lambda_u2d8 = this;
        ...
        public final Builder followSslRedirects(boolean followProtocolRedirects) {
            Builder $this$followSslRedirects_u24lambda_u2d9 = this;
        ...
        public final Builder cookieJar(CookieJar cookieJar) {
            ...
            Builder $this$cookieJar_u24lambda_u2d10 = this;
            $this$cookieJar_u24lambda_u2d10.setCookieJar$okhttp(cookieJar);
            return this;
        }

        public final Builder cache(Cache cache) {
            Builder $this$cache_u24lambda_u2d11 = this;
        ...
        public final Builder dns(Dns dns) {
            ...
            if (!Intrinsics.areEqual(dns, $this$dns_u24lambda_u2d12.getDns())) {
        ...
        public final Builder proxy(Proxy proxy) {
            ...
            if (!Intrinsics.areEqual(proxy, $this$proxy_u24lambda_u2d13.getProxy())) {
        ...
        public final Builder proxySelector(ProxySelector proxySelector) {
            ...
            if (!Intrinsics.areEqual(proxySelector, $this$proxySelector_u24lambda_u2d14.getProxySelector())) {
        ...
        public final Builder proxyAuthenticator(Authenticator proxyAuthenticator) {
            ...
            if (!Intrinsics.areEqual(proxyAuthenticator, $this$proxyAuthenticator_u24lambda_u2d15.getProxyAuthenticator())) {
        ...
        public final Builder socketFactory(SocketFactory socketFactory) {
            ...
            if (!Intrinsics.areEqual(socketFactory, $this$socketFactory_u24lambda_u2d17.getSocketFactory())) {
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sslSocketFactory) throws ClassNotFoundException {
            ...
            if (!Intrinsics.areEqual(sslSocketFactory, $this$sslSocketFactory_u24lambda_u2d18.getSslSocketFactoryOrNull())) {
            ...
            $this$sslSocketFactory_u24lambda_u2d18.setX509TrustManagerOrNull$okhttp(x509TrustManagerTrustManager);
            Platform platform = Platform.INSTANCE.get();
            X509TrustManager x509TrustManagerOrNull = $this$sslSocketFactory_u24lambda_u2d18.getX509TrustManagerOrNull();
            Intrinsics.checkNotNull(x509TrustManagerOrNull);
            $this$sslSocketFactory_u24lambda_u2d18.setCertificateChainCleaner$okhttp(platform.buildCertificateChainCleaner(x509TrustManagerOrNull));
            return this;
        }
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sslSocketFactory, X509TrustManager trustManager) {
            ...
            if (!Intrinsics.areEqual(sslSocketFactory, $this$sslSocketFactory_u24lambda_u2d19.getSslSocketFactoryOrNull()) || !Intrinsics.areEqual(trustManager, $this$sslSocketFactory_u24lambda_u2d19.getX509TrustManagerOrNull())) {
            ...
            $this$sslSocketFactory_u24lambda_u2d19.setCertificateChainCleaner$okhttp(CertificateChainCleaner.INSTANCE.get(trustManager));
        ...
        public final Builder protocols(List<? extends Protocol> protocols) {
            ...
            $this$protocols_u24lambda_u2d25.setProtocols$okhttp(listUnmodifiableList);
            return this;
        }
        ...
        public final Builder hostnameVerifier(HostnameVerifier hostnameVerifier) {
            ...
            if (!Intrinsics.areEqual(hostnameVerifier, $this$hostnameVerifier_u24lambda_u2d26.getHostnameVerifier())) {
        ...
        public final Builder certificatePinner(CertificatePinner certificatePinner) {
            ...
            if (!Intrinsics.areEqual(certificatePinner, $this$certificatePinner_u24lambda_u2d27.getCertificatePinner())) {
        ...
        public final Builder callTimeout(long timeout, TimeUnit unit) {
            ...
            Builder $this$callTimeout_u24lambda_u2d28 = this;
            $this$callTimeout_u24lambda_u2d28.setCallTimeout$okhttp(Util.checkDuration("timeout", timeout, unit));
            return this;
        }

        public final Builder callTimeout(Duration duration) {
            Intrinsics.checkNotNullParameter(duration, "duration");
            Builder $this$callTimeout_u24lambda_u2d29 = this;
        ...
        public final Builder connectTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            Builder $this$connectTimeout_u24lambda_u2d30 = this;
            $this$connectTimeout_u24lambda_u2d30.setConnectTimeout$okhttp(Util.checkDuration("timeout", timeout, unit));
            return this;
        }

        public final Builder connectTimeout(Duration duration) {
            Intrinsics.checkNotNullParameter(duration, "duration");
            Builder $this$connectTimeout_u24lambda_u2d31 = this;
        ...
        public final Builder readTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            Builder $this$readTimeout_u24lambda_u2d32 = this;
            $this$readTimeout_u24lambda_u2d32.setReadTimeout$okhttp(Util.checkDuration("timeout", timeout, unit));
            return this;
        }

        public final Builder readTimeout(Duration duration) {
            Intrinsics.checkNotNullParameter(duration, "duration");
            Builder $this$readTimeout_u24lambda_u2d33 = this;
        ...
        public final Builder writeTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            Builder $this$writeTimeout_u24lambda_u2d34 = this;
            $this$writeTimeout_u24lambda_u2d34.setWriteTimeout$okhttp(Util.checkDuration("timeout", timeout, unit));
            return this;
        }

        public final Builder writeTimeout(Duration duration) {
            Intrinsics.checkNotNullParameter(duration, "duration");
            Builder $this$writeTimeout_u24lambda_u2d35 = this;
        ...
        public final Builder pingInterval(long interval, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            Builder $this$pingInterval_u24lambda_u2d36 = this;
        ...
        public final Builder pingInterval(Duration duration) {
            Intrinsics.checkNotNullParameter(duration, "duration");
            Builder $this$pingInterval_u24lambda_u2d37 = this;
