...
public final class Request {
    ...
    public static class Builder {
        ...
        public Builder url(HttpUrl url) {
            Intrinsics.checkNotNullParameter(url, "url");
            Builder $this$url_u24lambda_u2d0 = this;
        ...
        public Builder url(String url) {
            ...
            if (StringsKt.startsWith(url, "ws:", true)) {
                ...
                finalUrl = Intrinsics.stringPlus("http:", strSubstring);
            } else if (StringsKt.startsWith(url, "wss:", true)) {
                String strSubstring2 = url.substring(4);
                Intrinsics.checkNotNullExpressionValue(strSubstring2, "this as java.lang.String).substring(startIndex)");
                finalUrl = Intrinsics.stringPlus("https:", strSubstring2);
            } else {
                finalUrl = url;
            }
        ...
        public Builder header(String name, String value) {
            ...
            Builder $this$header_u24lambda_u2d1 = this;
            $this$header_u24lambda_u2d1.getHeaders().set(name, value);
            return this;
        }
        ...
        public Builder addHeader(String name, String value) {
            Intrinsics.checkNotNullParameter(name, "name");
            Intrinsics.checkNotNullParameter(value, "value");
            Builder $this$addHeader_u24lambda_u2d2 = this;
            $this$addHeader_u24lambda_u2d2.getHeaders().add(name, value);
            return this;
        }

        public Builder removeHeader(String name) {
            Intrinsics.checkNotNullParameter(name, "name");
            Builder $this$removeHeader_u24lambda_u2d3 = this;
            $this$removeHeader_u24lambda_u2d3.getHeaders().removeAll(name);
            return this;
        }

        public Builder headers(Headers headers) {
            Intrinsics.checkNotNullParameter(headers, "headers");
            Builder $this$headers_u24lambda_u2d4 = this;
