...
public class Platform {
    ...
    public void logCloseableLeak(String message, Object stackTrace) {
        ...
        if (stackTrace == null) {
            logMessage = Intrinsics.stringPlus(logMessage, " To see where this was allocated, set the OkHttpClient logger level to FINE: Logger.getLogger(OkHttpClient.class.getName()).setLevel(Level.FINE);");
        }
    ...
    public SSLSocketFactory newSslSocketFactory(X509TrustManager trustManager) throws KeyManagementException {
        Intrinsics.checkNotNullParameter(trustManager, "trustManager");
        try {
            SSLContext $this$newSslSocketFactory_u24lambda_u2d1 = newSSLContext();
            $this$newSslSocketFactory_u24lambda_u2d1.init(null, new TrustManager[]{trustManager}, null);
            SSLSocketFactory socketFactory = $this$newSslSocketFactory_u24lambda_u2d1.getSocketFactory();
