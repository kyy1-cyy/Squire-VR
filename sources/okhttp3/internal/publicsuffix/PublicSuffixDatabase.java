...
public final class PublicSuffixDatabase {
    ...
    private final List<String> splitDomain(String domain) {
        ...
        if (Intrinsics.areEqual(CollectionsKt.last(domainLabels), HttpUrl.FRAGMENT_ENCODE_SET)) {
