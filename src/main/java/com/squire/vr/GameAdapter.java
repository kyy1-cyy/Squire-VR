...
public class GameAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void bindGame(GameViewHolder holder, final Game game, final int position) {
        ...
        try {
            ...
            // Set release name (small grey text under title)
            if (holder.releaseName != null) {
                holder.releaseName.setText(game.releaseName != null ? game.releaseName : "");
            }
            ...
            // Append size consistently.
            String size = (game.sizeMb == null || game.sizeMb.trim().isEmpty()) ? "-" : game.sizeMb.trim();
            ...
            String pkg = game.packageName == null ? "-" : game.packageName.trim();
            String dt = (game.date == null || game.date.trim().isEmpty() || "Unknown".equalsIgnoreCase(game.date.trim())) ? "-" : game.date.trim();
            ...
            holder.popularity.setText("Popularity: " + (int)game.popularityScore);
    ...
    static class GameViewHolder extends RecyclerView.ViewHolder {
        ...
        public GameViewHolder(View itemView) {
            ...
            this.releaseName = (TextView) itemView.findViewById(R.id.game_release);
