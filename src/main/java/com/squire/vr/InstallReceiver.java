        ...
        if (success) {
            ...
            if (obbSourcePath == null) {
                ...
                if (source.exists()) {
                    ...
                    boolean moved = false;
                    try {
                         moved = AutoInstaller.moveFolder(source, destPkg);
                    } catch (Exception e) {}
                    ...
                    if (moved) {
                        ...
                        boolean movedToFolder = false;
                        if (destFolder != null && !folderName.equals(pkgName)) {
                             try {
                                 movedToFolder = AutoInstaller.moveFolder(source, destFolder);
                             } catch (Exception e) {}
                        }
                            ...
                            if (parentDir != null && parentDir.exists()) {
                                ...
                                try {
                                    ...
                                    if (!candidateObb.exists() || !candidateObb.isDirectory()) {
                                        ...
                                        try {
                                            moved2 = AutoInstaller.moveFolder(candidateObb, destPkg2);
                                        } catch (Exception e) {}
                                        if (moved2) {
                                            obbMoved2 = true;
