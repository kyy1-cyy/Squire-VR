...
public class SquireManagerActivity extends AppCompatActivity {
    ...
    private final Shizuku.OnRequestPermissionResultListener REQUEST_PERMISSION_RESULT_LISTENER = new Shizuku.OnRequestPermissionResultListener() { 
        ...
        public final void onRequestPermissionResult(int i, int i2) {
            SquireManagerActivity.this.lambda$new$0(i, i2);
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() { 
            ...
            public final void onClick(View view) {
                SquireManagerActivity.this.lambda$onCreate$1(view);
            }
        });
        ...
        findViewById(R.id.btn_start_wireless).setOnClickListener(new View.OnClickListener() { 
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SquireManagerActivity.this.lambda$onCreate$2(view);
            }
        });
        findViewById(R.id.btn_start_root).setOnClickListener(new View.OnClickListener() { 
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SquireManagerActivity.this.lambda$onCreate$3(view);
            }
        });
        findViewById(R.id.btn_authorized_apps).setOnClickListener(new View.OnClickListener() { 
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SquireManagerActivity.this.lambda$onCreate$4(view);
            }
        });
        findViewById(R.id.btn_terminal).setOnClickListener(new View.OnClickListener() { 
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SquireManagerActivity.this.lambda$onCreate$5(view);
            }
        });
        findViewById(R.id.btn_pair).setOnClickListener(new View.OnClickListener() { 
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SquireManagerActivity.this.lambda$onCreate$6(view);
            }
        });
        checkShizukuStatus();
    }
        ...
        if (!this.isRunning) {
            ...
            new Thread(new Runnable() { 
                ...
                public final void run() {
                    try {
                        SquireManagerActivity.this.lambda$testObbAccess$9();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
    ...
    public /* synthetic */ void lambda$testObbAccess$9() throws InterruptedException, NoSuchMethodException, SecurityException {
        try {
            ...
            runOnUiThread(new Runnable() { 
                @Override // java.lang.Runnable
                public final void run() {
                    SquireManagerActivity.this.lambda$testObbAccess$7(exitCode);
                }
            });
            ...
            runOnUiThread(new Runnable() { 
                @Override // java.lang.Runnable
                public final void run() {
                    SquireManagerActivity.this.lambda$testObbAccess$8(e);
                }
            });
        }
    }
